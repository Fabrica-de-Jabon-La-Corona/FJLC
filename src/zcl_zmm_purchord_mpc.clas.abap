CLASS zcl_zmm_purchord_mpc DEFINITION
  PUBLIC
  ...
  PUBLIC SECTION.
    ...
    TYPES:
      ...
      END OF ts_poitems .
    TYPES:
  tt_poitems TYPE STANDARD TABLE OF ts_poitems .
    TYPES:
...
*Declaración de Entitiy Type para Pedidos de Compras.

    TYPES:
      BEGIN OF ts_de_poheader,
        po_number  TYPE c LENGTH 10,
        comp_code  TYPE c LENGTH 4,
        doc_type   TYPE c LENGTH 4,
        vendor     TYPE c LENGTH 10,
        ...
        doc_date   TYPE c LENGTH 10,
        shiptype   TYPE c LENGTH 2,
        to_poitems TYPE TABLE OF ts_poitems WITH DEFAULT KEY,
      END OF ts_de_poheader.
    TYPES:
      tt_de_poheader TYPE STANDARD TABLE OF ts_de_poheader.

    CONSTANTS gc_poheader TYPE /iwbep/if_mgw_med_odata_types=>ty_e_med_entity_name VALUE 'poHeader' ##NO_TEXT.
    CONSTANTS gc_poitems TYPE /iwbep/if_mgw_med_odata_types=>ty_e_med_entity_name VALUE 'poItems' ##NO_TEXT.
...
private section.
  ...
  constants GC_INCL_NAME type STRING value 'ZCL_ZMM_PURCHORD_MPC==========CP' ##NO_TEXT.

  methods DEFINE_POITEMS
    raising
      /IWBEP/CX_MGW_MED_EXCEPTION .
...
CLASS ZCL_ZMM_PURCHORD_MPC IMPLEMENTATION.
...
model->set_schema_namespace( 'ZMM_PURCHORD_SRV' ).
...
***********************************************************************************************************************************
 ...
 lo_association = model->create_association(
                            iv_association_name = 'to_poItems' "#EC NOTEXT
                            iv_left_type        = 'poHeader' "#EC NOTEXT
                            iv_right_type       = 'poItems' "#EC NOTEXT
                            iv_right_card       = 'M' "#EC NOTEXT
                            iv_left_card        = '1'  "#EC NOTEXT
                            iv_def_assoc_set    = abap_false ). "#EC NOTEXT
* Referential constraint for association - to_poItems
lo_ref_constraint = lo_association->create_ref_constraint( ).
lo_ref_constraint->add_property( iv_principal_property = 'PoNumber'   iv_dependent_property = 'PoNumber' ). "#EC NOTEXT
lo_assoc_set = model->create_association_set( iv_association_set_name  = 'to_poItemsSet'                         "#EC NOTEXT
                                              iv_left_entity_set_name  = 'poHeaderSet'              "#EC NOTEXT
                                              iv_right_entity_set_name = 'poItemsSet'             "#EC NOTEXT
                                              iv_association_name      = 'to_poItems' ).                                 "#EC NOTEXT
...
lo_nav_property = lo_entity_type->create_navigation_property( iv_property_name  = 'to_poItems' "#EC NOTEXT
                                                              iv_abap_fieldname = 'TO_POITEMS' "#EC NOTEXT
                                                              iv_association_name = 'to_poItems' ). "#EC NOTEXT
  endmethod.
...
lo_entity_type->bind_structure( iv_structure_name  = 'ZCL_ZMM_PURCHORD_MPC=>TS_POHEADER' ). "#EC NOTEXT
...
lo_entity_type = model->create_entity_type( iv_entity_type_name = 'poItems' iv_def_entity_set = abap_false ). "#EC NOTEXT
...
lo_entity_type->bind_structure( iv_structure_name  = 'ZCL_ZMM_PURCHORD_MPC=>TS_POITEMS' ). "#EC NOTEXT


***********************************************************************************************************************************
*   ENTITY SETS
***********************************************************************************************************************************
lo_entity_set = lo_entity_type->create_entity_set( 'poItemsSet' ). "#EC NOTEXT
...
*&---------------------------------------------------------------------*
  ...
  CONSTANTS: lc_gen_date_time TYPE timestamp VALUE '20250305142115'.                  "#EC NOTEXT
...
ls_text_element-parent_artifact_name   = 'poItems'.                            "#EC NOTEXT
